...
text_only_pattern = re.compile(r'[\u4e00-\u9fff_a-zA-Z]+')
...
def top_pages_info(parsed_doc):
    font_freq = {}
    # print("parsed_doc.blocks:",parsed_doc.blocks)
    ...
    def retrieve_title_candidates(key_idx):
        ...
        if len(sorted_freq) > 0:
            ...
            for freq_ in sorted_freq[list(sorted_freq.keys())[key_idx]]:
                ...
                print(freq_["text"])
                print(text_only_pattern.sub("", freq_["text"]).strip())
